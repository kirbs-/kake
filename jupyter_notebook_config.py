...
#  Choices: any of ['sha256', 'md5', 'sha224', 'sha3_512', 'sha3_384', 'blake2b', 'sha1', 'sha3_224', 'sha384', 'blake2s', 'sha512', 'sha3_256']
#  Default: 'sha256'
...
def scrub_output_pre_save(model, **kwargs):
    ...
    with open(f'/snapshots/snap_{time.time()}.ipynb', 'w') as f:
